...
//            destinations.add("Marina Bay Sands");
    ...
    public static ArrayList<ArrayList<int[]>> chooseTransport(final ArrayList<String> path, double budget) {
        ...
        Collections.sort(possibleModesWithinbudget, new Comparator<int[]>() {
            @Override
            public int compare(int[] o1, int[] o2) {
                if (getTotalTime(o1,path)==getTotalTime(o2,path)){
                    return 0;
                }
                return getTotalTime(o1,path)<(getTotalTime(o2,path))?-1:1;
            }
        });
